...
@testset "Aqua.jl" begin
    ...
    Aqua.test_ambiguities(XAIBase)
end

@testset "ExplicitImports.jl" begin
    @info "Running ExplicitImports.jl import-hygiene tests."
    @test check_no_stale_explicit_imports(XAIBase) === nothing
    @test check_all_explicit_imports_via_owners(XAIBase) === nothing
    @test check_all_qualified_accesses_via_owners(XAIBase) === nothing
    @test check_no_self_qualified_accesses(XAIBase) === nothing
end
