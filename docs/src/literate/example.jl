...
#md #
#md #     XAIBase.jl doesn't contain any XAI methods,
#md #     instead it provides the interface for developers to implement their own methods.
#md #
...
#md #     - [RelevancePropagation.jl](https://github.com/Julia-XAI/RelevancePropagation.jl) (only applicable on Flux.jl models)
#md #       - `LRP`
#md #       - `CRP`
#md #       - LRP-Rules
#md #         - `ZeroRule`
...
#md #         - `EpsilonPlus`
#md #         - `EpsilonPlusFlat`
#md #         - `EpsilonAlpha2Beta1`
#md #         - `EpsilonAlpha2Beta1Flat`
